...
class PrintPlanListSerializer(serializers.ModelSerializer):
    ...
    build_profile_title = serializers.CharField(source="build_profile.title", read_only=True)
    build_profile_material_name = serializers.CharField(source="build_profile.material.name", read_only=True)
