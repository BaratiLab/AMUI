...
for power in power_range:
    ...
    for velocity in velocity_range:
        ...
        #     commit_message = f"m_{material}_p_{power}_v_{velocity}"
        # )
...
process_map_name = f"m_{material}_p_{power_start}_{power_stop}_{power_step}_v_{velocity_start}_{velocity_stop}_{velocity_step}"
